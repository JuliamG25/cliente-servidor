...
<section class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Nombre :</span>
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Actualizar Nombre" required class="box">
            <span>email :</span>
         ...
         <div class="inputBox">
            ...
            <span>Vieja Contraseña :</span>
            <input type="password" name="update_pass" placeholder="Ingrese la contraseña anterior" class="box">
            <span>Nueva Contraseña :</span>
            <input type="password" name="new_pass" placeholder="Introduzca nueva contraseña" class="box">
