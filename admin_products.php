...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
         <input type="text" name="name" class="box" required placeholder="Añadir nombre del producto">
         <select name="category" class="box" required>
            <option value="" selected disabled>Selecciona el restaurante</option>
               <option value="mcdonald">Mc Donald</option>
               <option value="kfc">KFC</option>
               <option value="presto">Presto</option>
               <option value="Juan Valdez">Juan Valdez</option>
         </select>
         </div>
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="Añadir precio">
         <input type="file" name="image" required class="box" accept="image/jpg, image/jpeg, image/png">
         </div>
      </div>
      <textarea name="details" class="box" required placeholder="Descripcción del producto" cols="30" rows="10"></textarea>
